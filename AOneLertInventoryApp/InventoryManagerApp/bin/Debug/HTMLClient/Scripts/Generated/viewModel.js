...
(function (lightSwitchApplication) {
    ...
    function AddEditOrderRequisition(parameters, dataWorkspace) {
        ...
        /// </field>
        /// <field name="QueryCustomerGroupByTransportRoute" type="msls.VisualCollection" elementType="msls.application.Customer">
        /// Gets the queryCustomerGroupByTransportRoute for this screen.
        /// </field>
    ...
    function AddEditPickingSlip(parameters, dataWorkspace) {
        /// <summary>
        /// Represents the AddEditPickingSlip screen.
        /// </summary>
        /// <param name="parameters" type="Array">
        /// An array of screen parameter values.
        /// </param>
        ...
        /// Gets or sets the pickingSlip for this screen.
        /// </field>
        /// <field name="SelectedTransportRoute" type="msls.application.TransportRoute">
        /// Gets or sets the selectedTransportRoute for this screen.
        /// </field>
        /// <field name="QueryRequisitionDetailPicking" type="msls.VisualCollection" elementType="msls.application.OrderRequisitionDetail">
        /// Gets the queryRequisitionDetailPicking for this screen.
        /// </field>
        /// <field name="PickingSlipDetails" type="msls.VisualCollection" elementType="msls.application.PickingSlipDetail">
        /// Gets the pickingSlipDetails for this screen.
        /// </field>
        /// <field name="details" type="msls.application.AddEditPickingSlip.Details">
        /// Gets the details for this screen.
        /// </field>
        if (!dataWorkspace) {
            dataWorkspace = new lightSwitchApplication.DataWorkspace();
        }
        $Screen.call(this, dataWorkspace, "AddEditPickingSlip", parameters);
    }

    function AddEditPickingSlipDetail(parameters, dataWorkspace) {
        /// <summary>
        /// Represents the AddEditPickingSlipDetail screen.
        /// </summary>
        /// <param name="parameters" type="Array">
        /// An array of screen parameter values.
        /// </param>
        ...
        /// An existing data workspace for this screen to use. By default, a new data workspace is created.
        /// </param>
        /// <field name="PickingSlipDetail" type="msls.application.PickingSlipDetail">
        /// Gets or sets the pickingSlipDetail for this screen.
        /// </field>
        ...
        /// </field>
        /// <field name="SearchStockOnhand" type="String">
        /// Gets or sets the searchStockOnhand for this screen.
        /// </field>
        /// <field name="AvailableQuantity" type="Number">
        /// Gets or sets the availableQuantity for this screen.
        /// </field>
        /// <field name="details" type="msls.application.AddEditPickingSlipDetail.Details">
        /// Gets the details for this screen.
        /// </field>
        if (!dataWorkspace) {
            dataWorkspace = new lightSwitchApplication.DataWorkspace();
        }
        $Screen.call(this, dataWorkspace, "AddEditPickingSlipDetail", parameters);
    }
    ...
    msls._addToNamespace("msls.application", {
        ...
        AddEditOrderRequisition: $defineScreen(AddEditOrderRequisition, [
            ...
            {
                name: "QueryCustomerGroupByTransportRoute", kind: "collection", elementType: lightSwitchApplication.Customer,
                createQuery: function (SearchCustomer) {
                    return this.dataWorkspace.ApplicationData.QueryCustomerGroupByTransportRoute().filter("" + ((SearchCustomer === undefined || SearchCustomer === null) ? "true" : "substringof(" + $toODataString(SearchCustomer, "String?") + ", CustomerName)") + " or " + ((SearchCustomer === undefined || SearchCustomer === null) ? "true" : "substringof(" + $toODataString(SearchCustomer, "String?") + ", TransportRoute/TransportRouteName)") + "").orderBy("TransportRoute/TransportRouteName").thenBy("CustomerName").expand("TransportRoute");
                }
            },
        ...
        AddEditPickingSlip: $defineScreen(AddEditPickingSlip, [
            { name: "PickingSlip", kind: "local", type: lightSwitchApplication.PickingSlip },
            { name: "SelectedTransportRoute", kind: "local", type: lightSwitchApplication.TransportRoute },
            {
                name: "QueryRequisitionDetailPicking", kind: "collection", elementType: lightSwitchApplication.OrderRequisitionDetail,
                createQuery: function (SelectedTransportRouteID) {
                    return this.dataWorkspace.ApplicationData.QueryRequisitionDetailPicking(SelectedTransportRouteID).filter("" + ((SelectedTransportRouteID === undefined || SelectedTransportRouteID === null) ? "false" : "(OrderRequisition/Customer/TransportRoute/Id eq " + $toODataString(SelectedTransportRouteID, "Int32?") + ")") + "").expand("OrderRequisition").expand("OrderRequisition.Customer").expand("Product").expand("Product.UnitOfMeasure");
                }
            },
            {
                name: "PickingSlipDetails", kind: "collection", elementType: lightSwitchApplication.PickingSlipDetail,
                getNavigationProperty: function () {
                    if (this.owner.QueryRequisitionDetailPicking.selectedItem) {
                        return this.owner.QueryRequisitionDetailPicking.selectedItem.details.properties.PickingSlipDetails;
                    }
                    return null;
                },
                appendQuery: function () {
                    return this.filter("Id eq OrderRequisitionDetail/Id").expand("Location");
                }
            }
        ], [
        ...
        AddEditPickingSlipDetail: $defineScreen(AddEditPickingSlipDetail, [
            { name: "PickingSlipDetail", kind: "local", type: lightSwitchApplication.PickingSlipDetail },
            {
                name: "StockOnHandForSale", kind: "collection", elementType: lightSwitchApplication.StockOnHand,
                createQuery: function (SearchStockOnhand, OrderDetail_ProductID) {
                    return this.dataWorkspace.ApplicationData.StockOnHandForSale().filter("" + ((OrderDetail_ProductID === undefined || OrderDetail_ProductID === null) ? "false" : "(Product/Id eq " + $toODataString(OrderDetail_ProductID, "Int32?") + ")") + "").orderBy("Location/LocationName").thenBy("LotNo").expand("Product").expand("Location");
                }
            },
            { name: "SearchStockOnhand", kind: "local", type: String },
        ...
        BrowseOrderRequisitionsTransportRoute: $defineScreen(BrowseOrderRequisitionsTransportRoute, [
            ...
            },
            {
                name: "QueryRequisitionDetailPicking", kind: "collection", elementType: lightSwitchApplication.OrderRequisitionDetail,
                createQuery: function (SelectedTransportRouteID) {
                    return this.dataWorkspace.ApplicationData.QueryRequisitionDetailPicking(SelectedTransportRouteID);
                }
            }
        ], [
        ...
        showAddEditPickingSlip: $defineShowScreen(function showAddEditPickingSlip(PickingSlip, SelectedTransportRoute, options) {
            /// <summary>
            /// Asynchronously navigates forward to the AddEditPickingSlip screen.
            /// </summary>
            /// <param name="options" optional="true">
            /// An object that provides one or more of the following options:<br/>- beforeShown: a function that is called after boundary behavior has been applied but before the screen is shown.<br/>+ Signature: beforeShown(screen)<br/>- afterClosed: a function that is called after boundary behavior has been applied and the screen has been closed.<br/>+ Signature: afterClosed(screen, action : msls.NavigateBackAction)
            /// </param>
            ...
            return lightSwitchApplication.showScreen("AddEditPickingSlip", parameters, options);
        }),

        showAddEditPickingSlipDetail: $defineShowScreen(function showAddEditPickingSlipDetail(PickingSlipDetail, options) {
            /// <summary>
            /// Asynchronously navigates forward to the AddEditPickingSlipDetail screen.
            /// </summary>
            /// <param name="options" optional="true">
            /// An object that provides one or more of the following options:<br/>- beforeShown: a function that is called after boundary behavior has been applied but before the screen is shown.<br/>+ Signature: beforeShown(screen)<br/>- afterClosed: a function that is called after boundary behavior has been applied and the screen has been closed.<br/>+ Signature: afterClosed(screen, action : msls.NavigateBackAction)
            /// </param>
            /// <returns type="WinJS.Promise" />
            var parameters = Array.prototype.slice.call(arguments, 0, 1);
            return lightSwitchApplication.showScreen("AddEditPickingSlipDetail", parameters, options);
        }),
