...
(function (lightSwitchApplication) {
    ...
    function PickingSlip(entitySet) {
        ...
        /// </field>
        /// <field name="TruckLicense" type="String">
        /// Gets or sets the truckLicense for this pickingSlip.
        /// </field>
        /// <field name="TruckCapacityWeight" type="Number">
        /// Gets or sets the truckCapacityWeight for this pickingSlip.
        /// </field>
    ...
    msls._addToNamespace("msls.application", {
        ...
        PickingSlip: $defineEntity(PickingSlip, [
            ...
            { name: "TransportRoute", kind: "reference", type: TransportRoute },
            { name: "TruckLicense", type: String },
            { name: "TruckCapacityWeight", type: Number },
        ...
        ApplicationData: $defineDataService(ApplicationData, lightSwitchApplication.rootUri + "/ApplicationData.svc", [
            ...
            {
                name: "QueryCustomerGroupByTransportRoute", value: function () {
                    return new $DataServiceQuery({ _entitySet: this.Customers },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/QueryCustomerGroupByTransportRoute()",
                        {
                        });
                }
            },
            ...
            {
                name: "QueryRequisitionDetailPicking", value: function (SelectedTransportRouteID) {
                    return new $DataServiceQuery({ _entitySet: this.OrderRequisitionDetails },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/QueryRequisitionDetailPicking()",
                        {
                            SelectedTransportRouteID: $toODataString(SelectedTransportRouteID, "Int32?")
                        });
                }
            },
            {
            ...
            {
                name: "QueryMaxPickingNumber", value: function () {
                    return new $DataServiceQuery({ _entitySet: this.PickingSlips },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/QueryMaxPickingNumber()",
                        {
                        });
                }
            },
