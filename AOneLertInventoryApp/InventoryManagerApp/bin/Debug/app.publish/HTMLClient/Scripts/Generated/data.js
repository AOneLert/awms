...
(function (lightSwitchApplication) {
    ...
    function Requisition(entitySet) {
        /// <summary>
        /// Represents the Requisition entity type.
        /// </summary>
        /// <param name="entitySet" type="msls.EntitySet" optional="true">
        /// The entity set that should contain this requisition.
        /// </param>
        /// <field name="Id" type="Number">
        /// Gets or sets the id for this requisition.
        /// </field>
        /// <field name="RequisitionNo" type="String">
        /// Gets or sets the requisitionNo for this requisition.
        /// </field>
        /// <field name="RequisitionDate" type="Date">
        /// Gets or sets the requisitionDate for this requisition.
        /// </field>
        /// <field name="TransportRoute" type="msls.application.TransportRoute">
        /// Gets or sets the transportRoute for this requisition.
        /// </field>
        /// <field name="SaleOrderDetail" type="msls.application.SaleOrderDetail">
        /// Gets or sets the saleOrderDetail for this requisition.
        /// </field>
        /// <field name="TruckLicenceNo" type="String">
        /// Gets or sets the truckLicenceNo for this requisition.
        /// </field>
        /// <field name="NetWeight" type="Number">
        /// Gets or sets the netWeight for this requisition.
        /// </field>
        /// <field name="Remark" type="String">
        /// Gets or sets the remark for this requisition.
        /// </field>
        /// <field name="CreatedBy" type="String">
        /// Gets or sets the createdBy for this requisition.
        /// </field>
        /// <field name="Created" type="Date">
        /// Gets or sets the created for this requisition.
        /// </field>
        /// <field name="ModifiedBy" type="String">
        /// Gets or sets the modifiedBy for this requisition.
        /// </field>
        /// <field name="Modified" type="Date">
        /// Gets or sets the modified for this requisition.
        /// </field>
        /// <field name="RowVersion" type="Array">
        /// Gets or sets the rowVersion for this requisition.
        /// </field>
        /// <field name="details" type="msls.application.Requisition.Details">
        /// Gets the details for this requisition.
        /// </field>
        $Entity.call(this, entitySet);
    }
    ...
    function SaleOrderDetail(entitySet) {
        ...
        /// </field>
        /// <field name="Requisitions" type="msls.EntityCollection" elementType="msls.application.Requisition">
        /// Gets the requisitions for this saleOrderDetail.
        /// </field>
    ...
    function TransportRoute(entitySet) {
        ...
        /// </field>
        /// <field name="Requisitions" type="msls.EntityCollection" elementType="msls.application.Requisition">
        /// Gets the requisitions for this transportRoute.
        /// </field>
        /// <field name="CreatedBy" type="String">
    ...
    function ApplicationData(dataWorkspace) {
        ...
        /// </field>
        /// <field name="Requisitions" type="msls.EntitySet">
        /// Gets the Requisitions entity set.
        /// </field>
    ...
    msls._addToNamespace("msls.application", {
        ...
        Requisition: $defineEntity(Requisition, [
            { name: "Id", type: Number },
            { name: "RequisitionNo", type: String },
            { name: "RequisitionDate", type: Date },
            { name: "TransportRoute", kind: "reference", type: TransportRoute },
            { name: "SaleOrderDetail", kind: "reference", type: SaleOrderDetail },
            { name: "TruckLicenceNo", type: String },
        ...
        SaleOrderDetail: $defineEntity(SaleOrderDetail, [
            ...
            { name: "Requisitions", kind: "collection", elementType: Requisition },
        ...
        ApplicationData: $defineDataService(ApplicationData, lightSwitchApplication.rootUri + "/ApplicationData.svc", [
            ...
            { name: "Requisitions", elementType: Requisition },
            ...
            {
                name: "Requisitions_SingleOrDefault", value: function (Id) {
                    return new $DataServiceQuery({ _entitySet: this.Requisitions },
                        lightSwitchApplication.rootUri + "/ApplicationData.svc" + "/Requisitions(" + "Id=" + $toODataString(Id, "Int32?") + ")"
                    );
                }
            },
            {
