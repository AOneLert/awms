...
(function (lightSwitchApplication) {
    ...
    function BrowseRequisitions(parameters, dataWorkspace) {
        /// <summary>
        /// Represents the BrowseRequisitions screen.
        /// </summary>
        /// <param name="parameters" type="Array">
        /// An array of screen parameter values.
        /// </param>
        ...
        /// An existing data workspace for this screen to use. By default, a new data workspace is created.
        /// </param>
        /// <field name="SaleOrdersTransportRouteQuery" type="msls.VisualCollection" elementType="msls.application.SaleOrder">
        /// Gets the saleOrdersTransportRouteQuery for this screen.
        /// </field>
        /// <field name="details" type="msls.application.BrowseRequisitions.Details">
        /// Gets the details for this screen.
        /// </field>
        if (!dataWorkspace) {
            dataWorkspace = new lightSwitchApplication.DataWorkspace();
        }
        $Screen.call(this, dataWorkspace, "BrowseRequisitions", parameters);
    }
    ...
    msls._addToNamespace("msls.application", {
        ...
        BrowseRequisitions: $defineScreen(BrowseRequisitions, [
            {
                name: "SaleOrdersTransportRouteQuery", kind: "collection", elementType: lightSwitchApplication.SaleOrder,
                createQuery: function () {
                    return this.dataWorkspace.ApplicationData.SaleOrders.filter("SaleOrderStatus eq false").orderBy("Customer/TransportRoute/TransportRouteName").expand("Customer").expand("Customer.TransportRoute").expand("Customer.CustomerGroup");
                }
            }
        ], [
        ]),
        ...
        showBrowseRequisitions: $defineShowScreen(function showBrowseRequisitions(options) {
            /// <summary>
            /// Asynchronously navigates forward to the BrowseRequisitions screen.
            /// </summary>
            /// <param name="options" optional="true">
            /// An object that provides one or more of the following options:<br/>- beforeShown: a function that is called after boundary behavior has been applied but before the screen is shown.<br/>+ Signature: beforeShown(screen)<br/>- afterClosed: a function that is called after boundary behavior has been applied and the screen has been closed.<br/>+ Signature: afterClosed(screen, action : msls.NavigateBackAction)
            /// </param>
            /// <returns type="WinJS.Promise" />
            var parameters = Array.prototype.slice.call(arguments, 0, 0);
            return lightSwitchApplication.showScreen("BrowseRequisitions", parameters, options);
        }),
