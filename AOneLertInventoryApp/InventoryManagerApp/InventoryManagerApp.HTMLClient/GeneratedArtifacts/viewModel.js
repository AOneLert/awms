    ...
    msls._addToNamespace("msls.application", {
        ...
        AddEditPickingSlip: $defineScreen(AddEditPickingSlip, [
            { name: "PickingSlip", kind: "local", type: lightSwitchApplication.PickingSlip },
            {
                ...
                getNavigationProperty: function () {
                    if (this.owner.PickingSlip) {
                        return this.owner.PickingSlip.details.properties.PickingSlipDetails;
                    }
                    return null;
                },
                appendQuery: function () {
                    return this.expand("OrderRequisitionDetail").expand("Location");
                }
            }
        ], [
        ]),
        ...
        showAddEditPickingSlip: $defineShowScreen(function showAddEditPickingSlip(PickingSlip, options) {
            /// <summary>
